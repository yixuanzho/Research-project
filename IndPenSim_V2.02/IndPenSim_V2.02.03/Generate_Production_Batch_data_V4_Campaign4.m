...
Batch_run_flags.Control_strategy = 0*ones(1,Num_of_Batches); % 0 - Recipe driven (i.e Sequential batch control (SBC)) 
...
Batches_File_Name  = 'IndPenSim_V2_export_V7_Campaign4'; % File name for saving generated batches
